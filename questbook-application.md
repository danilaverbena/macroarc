...
- Stack: Solidity (parimutuel core, custom errors, zero external deps), ethers/viem, zero-build static dApp; wallet flow auto-configures Arc testnet.
...
Solo builder with a track record of shipping on Arc testnet and other L1/L2 testnets (multiple deployed dApps and tools). Proven shipping ability: this application is accompanied by a working product — contracts live on Arc testnet, verified end-to-end lifecycle, open-source repo, hosted frontend — built within days of concept.
